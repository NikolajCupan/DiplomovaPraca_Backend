...
public class TestService {
    ...
    public int dickeyFullerTest(
        ...
        try {
            final String jsonString = this.objectMapper.writeValueAsString(json);
            final String jsonFileName = PythonExecutor.saveJson(jsonString);
            PythonExecutor.executeAction(jsonFileName);
